...
export const PAID = new Map<string, { sku: string; credits?: number }>([
    ...
    ['/api/paid/insight/weekly', { sku: 'insight_weekly' }],
    ['/api/paid/insight/habit', { sku: 'insight_habit' }],
    ['/api/paid/insight/monthly', { sku: 'insight_monthly' }],
    ['/api/paid/habit-review', { sku: 'habit_review' }],
