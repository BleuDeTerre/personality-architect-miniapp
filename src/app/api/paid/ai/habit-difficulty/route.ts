// src/app/api/paid/ai/habit-difficulty/route.ts
// Paid version of ai/habit-difficulty - оплата через X402 ($0.25)
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const block = await requireX402(req, '/api/paid/ai/habit-difficulty');
